...
from ImBD.spo3 import ComputeScore
from ImBD.engine3 import run
import torch
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--eval_after_train', type=bool, default=True)
    ...
    parser.add_argument('--eval_dataset', type=str, default="./exp_prompt/data/xsum_mistralai-7b-instruct_rewrite")
    parser.add_argument('--output_file', type=str, default="./exp_prompt/results/xsum_mistralai-7b-instruct_rewrite")
    parser.add_argument('--base_model', type=str, default="mistralai-7b-instruct")
    parser.add_argument('--cache_dir', type=str, default="../cache")
    parser.add_argument('--train_dataset', type=str, default='./exp_prompt/data/squad_mistralai-7b-instruct_polish&./exp_prompt/data/writing_mistralai-7b-instruct_expand')
    ...
    # criterion_fn_name = 'mean_gap'
    criterion_fn_name = 'auc'
    model.set_criterion_fn(criterion_fn_name)
    args.criterion_fn = criterion_fn_name
